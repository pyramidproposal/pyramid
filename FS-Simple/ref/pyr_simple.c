...
static void stack_push(stack_type *stack, const unsigned char *push_node,
 ...
 */
static void tree_hash(unsigned char root[PYR_N], unsigned char next_ref[PYR_N],
 ...
 */
static void tree_sig(unsigned char sig[SIG_XMSS_BYTES],
                     const unsigned char M[PYR_N],
 ...
 */
static void update_treehash(const unsigned char sk_psd[PYR_N],
 ...
 */
static void xmss_root_from_sig(unsigned char root[PYR_N],
 ...
 */
static inline void fwd_ref(unsigned char *next_ref,
                           const unsigned char *fsg_ref,
...
/**
 * @brief Generate a BDS state from the core of a Pyramid secret key.
 ...
 */
static void bds_stateGen(const unsigned char sk[PYR_SK_BYTES],
                         state_type *state) {
 ...
 */
static void mmt_stateGen(const unsigned char sk[PYR_SK_BYTES],
 ...
 */
static inline void bds_fwd_refs(const unsigned char sk[PYR_SK_BYTES],
                                state_type *state) {
 ...
 */
static void bds_state_update(const unsigned char sk[PYR_SK_BYTES],
                             state_type *state) {
 ...
 */
static inline void update_ghost_treehash(state_type *state,
 ...
 */
static inline void mmt_fwd_refs(const unsigned char sk[PYR_SK_BYTES],
                                state_type *state, uint32_t layer) {
  uint32_t th_ref_addr[8] = {0};
 ...
 * @param[in] layer The hypertree layer of the MMT state.
 */
static void mmt_state_update(const unsigned char sk[PYR_SK_BYTES],
                             state_type *state, uint32_t layer) {
 ...
 */
static void state_serialize(unsigned char sk[PYR_SK_BYTES],
                            const state_type *state, unsigned int layer) {
  unsigned int i;
 ...
 */
static void state_deserialize(const unsigned char *sk, state_type *state,
                              unsigned int layer) {
  unsigned int i;
 ...
 */
static const unsigned char *sk_get_auth(const unsigned char sk[PYR_SK_BYTES],
                                        uint32_t layer) {
