...
/*
  Removed feature:
  1. If you want to speed up by increasing the state size,
  the original implementation allows you to  predefine
  WOTS_SIG_IN_STATE. Then, a state includes WOTS signature in each layer.

  2. If you want to reduce run time for key generation (2^{h/d-1} leaf
  computations are reduced), the original implementations allows you to
  predefine FAST_KEYGEN.

  3. SAFE_MODE was a debug option.
*/
